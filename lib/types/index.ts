...
export interface ConversationSession { id: string; title: string; goal: string; experts: ExpertAgentConfig[]; moderator: ModeratorConfig; autoDiscuss: boolean; history: {role:'user'|'assistant'|'system'|'expert'|'moderator'; content:string; name?:string}[]; }
